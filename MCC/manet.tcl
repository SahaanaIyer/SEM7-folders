...
# Setting a TCP Connection between n(1) & n(31)
...
# Setting a TCP Connection between n(31) & n(43)
set tcp [new Agent/TCP/Newreno]
$tcp set class_ 2
set sink [new Agent/TCPSink]
...
# Defining initial positions of nodes in nam
for { set i 0 } { $i < $val(nn) } { incr i } {
$ns initial_node_pos $n($i) 20;                # 20 is the node size for nam
}
