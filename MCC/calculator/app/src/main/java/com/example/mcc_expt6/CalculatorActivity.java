...
public class CalculatorActivity extends AppCompatActivity implements View.OnClickListener{
    Button btn_1,btn_2,btn_3,btn_4,btn_5,btn_6,btn_7,btn_8,btn_9,btn_0,btn_Add,btn_Sub,btn_Mul,btn_Div,btn_calc,btn_dec,btn_clear, btn_next;
    EditText ed1;
        ...
        switch (view.getId()) {
            ...
            case R.id.btn_calc:
                ...
                if (mAddition == true){
                    ...
                    ed1.setText(Value1 + " + " + Value2 + " = " + (Value1 + Value2) +"");
                    mAddition=false;
                }
                if (mSubtract == true){
                    result = Value1 - Value2;
    ...
    private void openNext(float result) {
        String output = String.valueOf(result);
        Intent intent = new Intent(CalculatorActivity.this, NextActivity.class);
